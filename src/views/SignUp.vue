                ...
                <div class="w-full max-w-xs">
                    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" autocomplete="off">
                        ...
                        <div v-if="success_message" class="bg-green-100 mb-2 border border-green-400 text-green-700 px-4 py-3 rounded relative"
                             role="alert">
                            <strong class="font-bold">Sign Up Successful</strong>
                        ...
                        <div class="mb-4">
                            ...
                            <input autocomplete="none"
                                   ...
                                   id="firstname" type="text" name="firstname" v-model="firstname" placeholder="Firstname">
                        ...
                        <div class="flex items-center justify-center">
                            <button v-if="firstname && email && password && !loading" v-on:click="submitForm"
                            ...
                            <button v-else type="button"
                                ...
                                Sign Up <span v-if="loading"><i class="fa fa-spin fa-spinner"></i></span>
                            </button>

                        </div>
                        <div class="w-full text-center">
                            <router-link to="/login"><small class="text-center w-full">Login</small></router-link>
                        </div>
            ...
            async submitForm() {
                try{
                    ...
                    if (this.firstname && this.email && this.password) {
                        this.error_message = "";
                        this.loading = true;
                        let {data: response} = await UserService.registerAdmin({
